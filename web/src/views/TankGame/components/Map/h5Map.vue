<template>
  <div id="wrap">
    ...
    <div id="canvas-wrap">
      ...
      <div class="overlay" id="ov-start">
        ...
        <p>
          ...
          AI可自定义，支持导入JS脚本，<a :href="aiGuideUrl" download
            >下载相关API</a
          >
        </p>
    ...
    <div id="controls" class="none-select">
      ...
      <div class="act">
        <button data-key="mine">💣</button>
        <button data-key="fire">🔥</button>
      </div>
    </div>
    <div id="btn-group" class="none-select game-active">
